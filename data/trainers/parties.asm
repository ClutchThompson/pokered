...
; Viridian Gym
	db $FF, 45, KANGASKHAN, 42, DUGTRIO, 44, NIDOQUEEN, 45, NIDOKING, 50, RHYDON, 0
...
BrunoData:
	db $FF, 53, POLIWRATH, 53, GOLEM, 55, HITMONCHAN, 55, HITMONLEE, 56, PRIMEAPE, 58, MACHAMP, 0
...
BlaineData:
	db $FF, 42, FLAREON, 45, MAGMAR, 42, RAPIDASH, 47, ARCANINE, 0

SabrinaData:
	db $FF, 38, SLOWBRO, 37, MR_MIME, 38, HYPNO, 43, ALAKAZAM, 0
...
LoreleiData:
	db $FF, 54, DEWGONG, 53, CLOYSTER, 54, VAPOREON, 56, JYNX, 56, LAPRAS, 0
...
AgathaData:
	db $FF, 56, GOLBAT, 56, ARBOK, 56, PARASECT, 55, NINETALES, 58, MAROWAK, 60, GENGAR, 0
